...
export const subtractHourStrings = (input: {cameraTime: string, deviceTime: string}): number =>  getSecondsFromHourString(input.deviceTime) - getSecondsFromHourString(input.cameraTime)
